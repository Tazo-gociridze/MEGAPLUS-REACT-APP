...
export const extraFunctionalityIcons: IconInfo[] = [
  ...
  },
  {
    ...
    description:
      "ასუფთავებს პროდუქციის შექმნისას პროდუქციაზე ინფორმაციის შესაყვან ველელბს.",
  },
  {
    src: "https://megaplus.vercel.app/assets/images/docs/value-extrafunctionality-icon.png",
    description:
      "თვითღირებულებასთან ერთად გამოაქვს პროდუქციების ჯამური გასაყიდი ფასი და მოგება.",
  },
  {
    ...
    height: 40,
    description:
      "როდესაც ფასის ცვლილება მონიშნულია, პროდუქციის ფასი ვეღარ შეიცვლება და ვერ დაედება კარფურის რეკომენდირებული ფასი, რეალურად ფასის ცვლილებით შეგვიძლია განვსაზღვროთ გვინდა თუ არა კარფურის რეკომენდირებულ ფასებზე ყოფნა , თუ ფასის ცვლილება არ არის მონიშნული, პროდუქციას ავტომატურად დაედება კარფურის რეკომენდირებული ფასი.",
  },
  {
  ...
  },
  {
    ...
    description:
      "თუ მოვნიშნავთ გვაჩვენებს წაშლილ და ასევე არააქტიურ პროდუქციებსაც.",
  },
  {
    src: "https://megaplus.vercel.app/assets/images/docs/hide-icon.png",
    description:
      "დამალავს ისეთ პროდუქციებს რომელიც პროგრამულად არ გვაქვს ნაშთზე.",
  },
  {
