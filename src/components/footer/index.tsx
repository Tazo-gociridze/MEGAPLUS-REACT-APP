        ...
        <div className="flex justify-between">
          <div className="flex flex-col items-start">
            <span className="!mb-4 flex items-center gap-x-3 text-2xl">
              <span>კონტაქტი</span> <RiContactsBook3Line className="text-red-300" />
            </span>
            <ul className="flex flex-col items-start gap-y-2">
              <li className="flex items-center gap-x-3 hover:text-red-300 hover:underline">
                <IoPhonePortraitOutline className="text-lg text-red-300" />
                <a href="tel:+995592003232">+995 00 32 32</a>
              </li>
              <li>
                <a
                  href="mailto:INFO@MEGAPLUS.GE"
                  className="flex items-center gap-x-3 hover:text-red-300 hover:underline"
                >
                  <CiMail className="text-lg text-red-300" />
          ...
          <div className="flex flex-col items-start">
            <span className="!mb-6 flex items-center gap-x-3 text-2xl">
              <span>სოციალური მედია</span> <GoPersonAdd className="text-red-300" />
            </span>
