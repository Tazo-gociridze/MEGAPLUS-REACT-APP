...
const NavBar = () => {
  ...
  return (
    <div className="flex w-screen items-center gap-x-26">
      ...
      <nav className="ibm-plex-serif-extralight header-navbar noto-sans-georgian flex items-center justify-center gap-x-10 text-[1rem] !font-[350] text-[#0B0642] dark:text-[var(--white-gray)]">
        <NavLink name={t('home-link')} path="/" />
        {/* <NavLink name={t('blog-link')} path="/blogs" /> */}
